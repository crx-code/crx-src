...
int main(void)
{
  ...
  CRX_NEW_EXTENSION(fileinfo, fileinfo.c crx_libmagic.c $libmagic_sources, $ext_shared,,-I@ext_srcdir@/libmagic)
  CRX_ADD_BUILD_DIR($ext_builddir/libmagic)
