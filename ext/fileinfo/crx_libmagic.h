...
#ifndef CRX_LIBMAGIC_H
#define CRX_LIBMAGIC_H
...
#define asctime_r crx_asctime_r
#define HAVE_CTIME_R 1
#define ctime_r crx_ctime_r
...
#define abort()	crex_error_noreturn(E_ERROR, "fatal libmagic error")

crex_string* convert_libmagic_pattern(const char *val, size_t len, uint32_t options);

#endif	/* CRX_LIBMAGIC_H */
