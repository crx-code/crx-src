...
#define CRX_FILTER_ID_EXISTS(id) \
...
#define CRX_FILTER_TRIM_DEFAULT(p, len) CRX_FILTER_TRIM_DEFAULT_EX(p, len, 1);

#define CRX_FILTER_TRIM_DEFAULT_EX(p, len, return_if_empty) { \
