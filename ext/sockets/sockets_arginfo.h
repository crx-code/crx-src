...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_select, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
...
CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_create_listen, 0, 1, Socket, MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, port, IS_LONG, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, backlog, IS_LONG, 0, "128")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_accept, 0, 1, Socket, MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_set_nonblock, 0, 1, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
CREX_END_ARG_INFO()

#define arginfo_socket_set_block arginfo_socket_set_nonblock

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_listen, 0, 1, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, backlog, IS_LONG, 0, "0")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_close, 0, 1, IS_VOID, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_write, 0, 2, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, data, IS_STRING, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, length, IS_LONG, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_read, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, length, IS_LONG, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "CRX_BINARY_READ")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_getsockname, 0, 2, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_INFO(1, address)
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, port, "null")
CREX_END_ARG_INFO()

#define arginfo_socket_getpeername arginfo_socket_getsockname

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_create, 0, 3, Socket, MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, domain, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, type, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, protocol, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_connect, 0, 2, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, address, IS_STRING, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, port, IS_LONG, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_strerror, 0, 1, IS_STRING, 0)
	CREX_ARG_TYPE_INFO(0, error_code, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_bind, 0, 2, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, address, IS_STRING, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, port, IS_LONG, 0, "0")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_recv, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_INFO(1, data)
	CREX_ARG_TYPE_INFO(0, length, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_send, 0, 4, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, data, IS_STRING, 0)
	CREX_ARG_TYPE_INFO(0, length, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_recvfrom, 0, 5, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_INFO(1, data)
	CREX_ARG_TYPE_INFO(0, length, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_sendto, 0, 5, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, data, IS_STRING, 0)
	CREX_ARG_TYPE_INFO(0, length, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_get_option, 0, 3, MAY_BE_ARRAY|MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_set_option, 0, 4, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, level, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, option, IS_LONG, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_create_pair, 0, 4, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, domain, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, type, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, protocol, IS_LONG, 0)
	CREX_ARG_INFO(1, pair)
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_SHUTDOWN)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_shutdown, 0, 1, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "2")
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_SOCKATMARK)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_atmark, 0, 1, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
CREX_END_ARG_INFO()
#endif

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_last_error, 0, 0, IS_LONG, 0)
	CREX_ARG_OBJ_INFO_WITH_DEFAULT_VALUE(0, socket, Socket, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_clear_error, 0, 0, IS_VOID, 0)
	CREX_ARG_OBJ_INFO_WITH_DEFAULT_VALUE(0, socket, Socket, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_import_stream, 0, 1, Socket, MAY_BE_FALSE)
	CREX_ARG_INFO(0, stream)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_INFO_EX(arginfo_socket_export_stream, 0, 0, 1)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_sendmsg, 0, 2, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(0, message, IS_ARRAY, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, flags, IS_LONG, 0, "0")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_recvmsg, 0, 2, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
	CREX_ARG_TYPE_INFO(1, message, IS_ARRAY, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, flags, IS_LONG, 0, "0")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_cmsg_space, 0, 2, IS_LONG, 1)
	CREX_ARG_TYPE_INFO(0, level, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, type, IS_LONG, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, num, IS_LONG, 0, "0")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_addrinfo_lookup, 0, 1, MAY_BE_ARRAY|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, host, IS_STRING, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, service, IS_STRING, 1, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, hints, IS_ARRAY, 0, "[]")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_addrinfo_connect, 0, 1, Socket, MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, address, AddressInfo, 0)
CREX_END_ARG_INFO()

#define arginfo_socket_addrinfo_bind arginfo_socket_addrinfo_connect

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_addrinfo_explain, 0, 1, IS_ARRAY, 0)
	CREX_ARG_OBJ_INFO(0, address, AddressInfo, 0)
CREX_END_ARG_INFO()

#if defined(CRX_WIN32)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_socket_wsaprotocol_info_export, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, socket, Socket, 0)
...
#if defined(CRX_WIN32)
CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_socket_wsaprotocol_info_import, 0, 1, Socket, MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, info_id, IS_STRING, 0)
CREX_END_ARG_INFO()
#endif

#if defined(CRX_WIN32)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_socket_wsaprotocol_info_release, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, info_id, IS_STRING, 0)
CREX_END_ARG_INFO()
#endif


CREX_FUNCTION(socket_select);
CREX_FUNCTION(socket_create_listen);
CREX_FUNCTION(socket_accept);
CREX_FUNCTION(socket_set_nonblock);
CREX_FUNCTION(socket_set_block);
CREX_FUNCTION(socket_listen);
CREX_FUNCTION(socket_close);
CREX_FUNCTION(socket_write);
CREX_FUNCTION(socket_read);
CREX_FUNCTION(socket_getsockname);
CREX_FUNCTION(socket_getpeername);
CREX_FUNCTION(socket_create);
CREX_FUNCTION(socket_connect);
CREX_FUNCTION(socket_strerror);
CREX_FUNCTION(socket_bind);
CREX_FUNCTION(socket_recv);
CREX_FUNCTION(socket_send);
CREX_FUNCTION(socket_recvfrom);
CREX_FUNCTION(socket_sendto);
CREX_FUNCTION(socket_get_option);
CREX_FUNCTION(socket_set_option);
#if defined(HAVE_SOCKETPAIR)
CREX_FUNCTION(socket_create_pair);
#endif
#if defined(HAVE_SHUTDOWN)
CREX_FUNCTION(socket_shutdown);
#endif
#if defined(HAVE_SOCKATMARK)
CREX_FUNCTION(socket_atmark);
#endif
CREX_FUNCTION(socket_last_error);
CREX_FUNCTION(socket_clear_error);
CREX_FUNCTION(socket_import_stream);
CREX_FUNCTION(socket_export_stream);
CREX_FUNCTION(socket_sendmsg);
CREX_FUNCTION(socket_recvmsg);
CREX_FUNCTION(socket_cmsg_space);
CREX_FUNCTION(socket_addrinfo_lookup);
CREX_FUNCTION(socket_addrinfo_connect);
CREX_FUNCTION(socket_addrinfo_bind);
CREX_FUNCTION(socket_addrinfo_explain);
#if defined(CRX_WIN32)
CREX_FUNCTION(socket_wsaprotocol_info_export);
#endif
#if defined(CRX_WIN32)
CREX_FUNCTION(socket_wsaprotocol_info_import);
#endif
#if defined(CRX_WIN32)
CREX_FUNCTION(socket_wsaprotocol_info_release);
#endif


static const crex_function_entry ext_functions[] = {
	CREX_FE(socket_select, arginfo_socket_select)
	CREX_FE(socket_create_listen, arginfo_socket_create_listen)
	CREX_FE(socket_accept, arginfo_socket_accept)
	CREX_FE(socket_set_nonblock, arginfo_socket_set_nonblock)
	CREX_FE(socket_set_block, arginfo_socket_set_block)
	CREX_FE(socket_listen, arginfo_socket_listen)
	CREX_FE(socket_close, arginfo_socket_close)
	CREX_FE(socket_write, arginfo_socket_write)
	CREX_FE(socket_read, arginfo_socket_read)
	CREX_FE(socket_getsockname, arginfo_socket_getsockname)
	CREX_FE(socket_getpeername, arginfo_socket_getpeername)
	CREX_FE(socket_create, arginfo_socket_create)
	CREX_FE(socket_connect, arginfo_socket_connect)
	CREX_FE(socket_strerror, arginfo_socket_strerror)
	CREX_FE(socket_bind, arginfo_socket_bind)
	CREX_FE(socket_recv, arginfo_socket_recv)
	CREX_FE(socket_send, arginfo_socket_send)
	CREX_FE(socket_recvfrom, arginfo_socket_recvfrom)
	CREX_FE(socket_sendto, arginfo_socket_sendto)
	CREX_FE(socket_get_option, arginfo_socket_get_option)
	CREX_FALIAS(socket_getopt, socket_get_option, arginfo_socket_getopt)
	CREX_FE(socket_set_option, arginfo_socket_set_option)
	CREX_FALIAS(socket_setopt, socket_set_option, arginfo_socket_setopt)
#if defined(HAVE_SOCKETPAIR)
	CREX_FE(socket_create_pair, arginfo_socket_create_pair)
#endif
#if defined(HAVE_SHUTDOWN)
	CREX_FE(socket_shutdown, arginfo_socket_shutdown)
#endif
#if defined(HAVE_SOCKATMARK)
	CREX_FE(socket_atmark, arginfo_socket_atmark)
#endif
	CREX_FE(socket_last_error, arginfo_socket_last_error)
	CREX_FE(socket_clear_error, arginfo_socket_clear_error)
	CREX_FE(socket_import_stream, arginfo_socket_import_stream)
	CREX_FE(socket_export_stream, arginfo_socket_export_stream)
	CREX_FE(socket_sendmsg, arginfo_socket_sendmsg)
	CREX_FE(socket_recvmsg, arginfo_socket_recvmsg)
	CREX_FE(socket_cmsg_space, arginfo_socket_cmsg_space)
	CREX_FE(socket_addrinfo_lookup, arginfo_socket_addrinfo_lookup)
	CREX_FE(socket_addrinfo_connect, arginfo_socket_addrinfo_connect)
	CREX_FE(socket_addrinfo_bind, arginfo_socket_addrinfo_bind)
	CREX_FE(socket_addrinfo_explain, arginfo_socket_addrinfo_explain)
#if defined(CRX_WIN32)
	CREX_FE(socket_wsaprotocol_info_export, arginfo_socket_wsaprotocol_info_export)
#endif
#if defined(CRX_WIN32)
	CREX_FE(socket_wsaprotocol_info_import, arginfo_socket_wsaprotocol_info_import)
#endif
#if defined(CRX_WIN32)
	CREX_FE(socket_wsaprotocol_info_release, arginfo_socket_wsaprotocol_info_release)
#endif
	CREX_FE_END
};


static const crex_function_entry class_Socket_methods[] = {
	CREX_FE_END
};


static const crex_function_entry class_AddressInfo_methods[] = {
	CREX_FE_END
};
...
#endif
	REGISTER_LONG_CONSTANT("CRX_NORMAL_READ", CRX_NORMAL_READ, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("CRX_BINARY_READ", CRX_BINARY_READ, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MCAST_JOIN_GROUP", CRX_MCAST_JOIN_GROUP, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("MCAST_LEAVE_GROUP", CRX_MCAST_LEAVE_GROUP, CONST_PERSISTENT);
#if defined(HAS_MCAST_EXT)
	REGISTER_LONG_CONSTANT("MCAST_BLOCK_SOURCE", CRX_MCAST_BLOCK_SOURCE, CONST_PERSISTENT);
#endif
#if defined(HAS_MCAST_EXT)
	REGISTER_LONG_CONSTANT("MCAST_UNBLOCK_SOURCE", CRX_MCAST_UNBLOCK_SOURCE, CONST_PERSISTENT);
#endif
#if defined(HAS_MCAST_EXT)
	REGISTER_LONG_CONSTANT("MCAST_JOIN_SOURCE_GROUP", CRX_MCAST_JOIN_SOURCE_GROUP, CONST_PERSISTENT);
#endif
#if defined(HAS_MCAST_EXT)
	REGISTER_LONG_CONSTANT("MCAST_LEAVE_SOURCE_GROUP", CRX_MCAST_LEAVE_SOURCE_GROUP, CONST_PERSISTENT);
#endif
...
#endif
#if defined(CRX_SOCKET_EINTR)
	REGISTER_LONG_CONSTANT("SOCKET_EINTR", CRX_SOCKET_EINTR, CONST_PERSISTENT);
#endif
#if defined(EIO)
...
#endif
#if defined(CRX_SOCKET_EBADF)
	REGISTER_LONG_CONSTANT("SOCKET_EBADF", CRX_SOCKET_EBADF, CONST_PERSISTENT);
#endif
#if defined(EAGAIN)
...
#endif
#if defined(CRX_SOCKET_EACCES)
	REGISTER_LONG_CONSTANT("SOCKET_EACCES", CRX_SOCKET_EACCES, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EFAULT)
	REGISTER_LONG_CONSTANT("SOCKET_EFAULT", CRX_SOCKET_EFAULT, CONST_PERSISTENT);
#endif
#if defined(ENOTBLK)
...
#endif
#if defined(CRX_SOCKET_EINVAL)
	REGISTER_LONG_CONSTANT("SOCKET_EINVAL", CRX_SOCKET_EINVAL, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENFILE)
	REGISTER_LONG_CONSTANT("SOCKET_ENFILE", CRX_SOCKET_ENFILE, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EMFILE)
	REGISTER_LONG_CONSTANT("SOCKET_EMFILE", CRX_SOCKET_EMFILE, CONST_PERSISTENT);
#endif
#if defined(ENOTTY)
...
#endif
#if defined(CRX_SOCKET_ENAMETOOLONG)
	REGISTER_LONG_CONSTANT("SOCKET_ENAMETOOLONG", CRX_SOCKET_ENAMETOOLONG, CONST_PERSISTENT);
#endif
#if defined(ENOLCK)
...
#endif
#if defined(CRX_SOCKET_ENOTEMPTY)
	REGISTER_LONG_CONSTANT("SOCKET_ENOTEMPTY", CRX_SOCKET_ENOTEMPTY, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ELOOP)
	REGISTER_LONG_CONSTANT("SOCKET_ELOOP", CRX_SOCKET_ELOOP, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EWOULDBLOCK)
	REGISTER_LONG_CONSTANT("SOCKET_EWOULDBLOCK", CRX_SOCKET_EWOULDBLOCK, CONST_PERSISTENT);
#endif
#if defined(ENOMSG)
...
#endif
#if defined(CRX_SOCKET_EREMOTE)
	REGISTER_LONG_CONSTANT("SOCKET_EREMOTE", CRX_SOCKET_EREMOTE, CONST_PERSISTENT);
#endif
#if defined(ENOLINK)
...
#endif
#if defined(CRX_SOCKET_EUSERS)
	REGISTER_LONG_CONSTANT("SOCKET_EUSERS", CRX_SOCKET_EUSERS, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENOTSOCK)
	REGISTER_LONG_CONSTANT("SOCKET_ENOTSOCK", CRX_SOCKET_ENOTSOCK, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EDESTADDRREQ)
	REGISTER_LONG_CONSTANT("SOCKET_EDESTADDRREQ", CRX_SOCKET_EDESTADDRREQ, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EMSGSIZE)
	REGISTER_LONG_CONSTANT("SOCKET_EMSGSIZE", CRX_SOCKET_EMSGSIZE, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EPROTOTYPE)
	REGISTER_LONG_CONSTANT("SOCKET_EPROTOTYPE", CRX_SOCKET_EPROTOTYPE, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENOPROTOOPT)
	REGISTER_LONG_CONSTANT("SOCKET_ENOPROTOOPT", CRX_SOCKET_ENOPROTOOPT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EPROTONOSUPPORT)
	REGISTER_LONG_CONSTANT("SOCKET_EPROTONOSUPPORT", CRX_SOCKET_EPROTONOSUPPORT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ESOCKTNOSUPPORT)
	REGISTER_LONG_CONSTANT("SOCKET_ESOCKTNOSUPPORT", CRX_SOCKET_ESOCKTNOSUPPORT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EOPNOTSUPP)
	REGISTER_LONG_CONSTANT("SOCKET_EOPNOTSUPP", CRX_SOCKET_EOPNOTSUPP, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EPFNOSUPPORT)
	REGISTER_LONG_CONSTANT("SOCKET_EPFNOSUPPORT", CRX_SOCKET_EPFNOSUPPORT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EAFNOSUPPORT)
	REGISTER_LONG_CONSTANT("SOCKET_EAFNOSUPPORT", CRX_SOCKET_EAFNOSUPPORT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EADDRINUSE)
	REGISTER_LONG_CONSTANT("SOCKET_EADDRINUSE", CRX_SOCKET_EADDRINUSE, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EADDRNOTAVAIL)
	REGISTER_LONG_CONSTANT("SOCKET_EADDRNOTAVAIL", CRX_SOCKET_EADDRNOTAVAIL, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENETDOWN)
	REGISTER_LONG_CONSTANT("SOCKET_ENETDOWN", CRX_SOCKET_ENETDOWN, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENETUNREACH)
	REGISTER_LONG_CONSTANT("SOCKET_ENETUNREACH", CRX_SOCKET_ENETUNREACH, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENETRESET)
	REGISTER_LONG_CONSTANT("SOCKET_ENETRESET", CRX_SOCKET_ENETRESET, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ECONNABORTED)
	REGISTER_LONG_CONSTANT("SOCKET_ECONNABORTED", CRX_SOCKET_ECONNABORTED, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ECONNRESET)
	REGISTER_LONG_CONSTANT("SOCKET_ECONNRESET", CRX_SOCKET_ECONNRESET, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENOBUFS)
	REGISTER_LONG_CONSTANT("SOCKET_ENOBUFS", CRX_SOCKET_ENOBUFS, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EISCONN)
	REGISTER_LONG_CONSTANT("SOCKET_EISCONN", CRX_SOCKET_EISCONN, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ENOTCONN)
	REGISTER_LONG_CONSTANT("SOCKET_ENOTCONN", CRX_SOCKET_ENOTCONN, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ESHUTDOWN)
	REGISTER_LONG_CONSTANT("SOCKET_ESHUTDOWN", CRX_SOCKET_ESHUTDOWN, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ETOOMANYREFS)
	REGISTER_LONG_CONSTANT("SOCKET_ETOOMANYREFS", CRX_SOCKET_ETOOMANYREFS, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ETIMEDOUT)
	REGISTER_LONG_CONSTANT("SOCKET_ETIMEDOUT", CRX_SOCKET_ETIMEDOUT, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_ECONNREFUSED)
	REGISTER_LONG_CONSTANT("SOCKET_ECONNREFUSED", CRX_SOCKET_ECONNREFUSED, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EHOSTDOWN)
	REGISTER_LONG_CONSTANT("SOCKET_EHOSTDOWN", CRX_SOCKET_EHOSTDOWN, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EHOSTUNREACH)
	REGISTER_LONG_CONSTANT("SOCKET_EHOSTUNREACH", CRX_SOCKET_EHOSTUNREACH, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EALREADY)
	REGISTER_LONG_CONSTANT("SOCKET_EALREADY", CRX_SOCKET_EALREADY, CONST_PERSISTENT);
#endif
#if defined(CRX_SOCKET_EINPROGRESS)
	REGISTER_LONG_CONSTANT("SOCKET_EINPROGRESS", CRX_SOCKET_EINPROGRESS, CONST_PERSISTENT);
#endif
#if defined(EISNAM)
...
#endif
#if defined(CRX_SOCKET_EDQUOT)
	REGISTER_LONG_CONSTANT("SOCKET_EDQUOT", CRX_SOCKET_EDQUOT, CONST_PERSISTENT);
#endif
...
static crex_class_entry *register_class_Socket(void)
{
...
static crex_class_entry *register_class_AddressInfo(void)
{
	crex_class_entry ce, *class_entry;
