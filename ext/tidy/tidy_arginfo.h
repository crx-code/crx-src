...
CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_tidy_parse_string, 0, 1, tidy, MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, string, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_tidy_get_error_buffer, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tidy_get_output, 0, 1, IS_STRING, 0)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_tidy_parse_file, 0, 1, tidy, MAY_BE_FALSE)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tidy_clean_repair, 0, 1, _IS_BOOL, 0)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_tidy_repair_string, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, string, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_tidy_repair_file, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, useIncludePath, _IS_BOOL, 0, "false")
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tidy_get_release, 0, 0, IS_STRING, 0)
CREX_END_ARG_INFO()

#if defined(HAVE_TIDYOPTGETDOC)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_tidy_get_opt_doc, 0, 2, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
	CREX_ARG_TYPE_INFO(0, option, IS_STRING, 0)
CREX_END_ARG_INFO()
#endif

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tidy_get_config, 0, 1, IS_ARRAY, 0)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_tidy_get_status, 0, 1, IS_LONG, 0)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_tidy_getopt, 0, 2, MAY_BE_STRING|MAY_BE_LONG|MAY_BE_BOOL)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
	CREX_ARG_TYPE_INFO(0, option, IS_STRING, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_tidy_get_root, 0, 1, tidyNode, 1)
	CREX_ARG_OBJ_INFO(0, tidy, tidy, 0)
CREX_END_ARG_INFO()
...
CREX_BEGIN_ARG_INFO_EX(arginfo_class_tidy___main, 0, 0, 0)
...
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_MASK_EX(arginfo_class_tidy_getOpt, 0, 1, MAY_BE_STRING|MAY_BE_LONG|MAY_BE_BOOL)
	CREX_ARG_TYPE_INFO(0, option, IS_STRING, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_cleanRepair, 0, 0, _IS_BOOL, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_parseFile, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, useIncludePath, _IS_BOOL, 0, "false")
...
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_parseString, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, string, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_MASK_EX(arginfo_class_tidy_repairString, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, string, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_MASK_EX(arginfo_class_tidy_repairFile, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, filename, IS_STRING, 0)
	CREX_ARG_TYPE_MASK(0, config, MAY_BE_ARRAY|MAY_BE_STRING|MAY_BE_NULL, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, encoding, IS_STRING, 1, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, useIncludePath, _IS_BOOL, 0, "false")
...
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_getRelease, 0, 0, IS_STRING, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_getConfig, 0, 0, IS_ARRAY, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_tidy_getStatus, 0, 0, IS_LONG, 0)
CREX_END_ARG_INFO()

#define arginfo_class_tidy_getHtmlVer arginfo_class_tidy_getStatus

#if defined(HAVE_TIDYOPTGETDOC)
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_MASK_EX(arginfo_class_tidy_getOptDoc, 0, 1, MAY_BE_STRING|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, option, IS_STRING, 0)
CREX_END_ARG_INFO()
#endif
...
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_OBJ_INFO_EX(arginfo_class_tidy_root, 0, 0, tidyNode, 1)
CREX_END_ARG_INFO()
...
CREX_BEGIN_ARG_INFO_EX(arginfo_class_tidyNode___main, 0, 0, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_tidyNode_hasChildren, 0, 0, _IS_BOOL, 0)
CREX_END_ARG_INFO()
...
#define arginfo_class_tidyNode_isCrx arginfo_class_tidyNode_hasChildren

CREX_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_class_tidyNode_getParent, 0, 0, tidyNode, 1)
CREX_END_ARG_INFO()


CREX_FUNCTION(tidy_parse_string);
CREX_FUNCTION(tidy_get_error_buffer);
CREX_FUNCTION(tidy_get_output);
CREX_FUNCTION(tidy_parse_file);
CREX_FUNCTION(tidy_clean_repair);
CREX_FUNCTION(tidy_repair_string);
CREX_FUNCTION(tidy_repair_file);
CREX_FUNCTION(tidy_diagnose);
CREX_FUNCTION(tidy_get_release);
#if defined(HAVE_TIDYOPTGETDOC)
CREX_FUNCTION(tidy_get_opt_doc);
#endif
CREX_FUNCTION(tidy_get_config);
CREX_FUNCTION(tidy_get_status);
CREX_FUNCTION(tidy_get_html_ver);
CREX_FUNCTION(tidy_is_xhtml);
CREX_FUNCTION(tidy_is_xml);
CREX_FUNCTION(tidy_error_count);
CREX_FUNCTION(tidy_warning_count);
CREX_FUNCTION(tidy_access_count);
CREX_FUNCTION(tidy_config_count);
CREX_FUNCTION(tidy_getopt);
CREX_FUNCTION(tidy_get_root);
CREX_FUNCTION(tidy_get_html);
CREX_FUNCTION(tidy_get_head);
CREX_FUNCTION(tidy_get_body);
CREX_METHOD(tidy, __main);
CREX_METHOD(tidy, parseFile);
CREX_METHOD(tidy, parseString);
CREX_METHOD(tidyNode, __main);
CREX_METHOD(tidyNode, hasChildren);
CREX_METHOD(tidyNode, hasSiblings);
CREX_METHOD(tidyNode, isComment);
CREX_METHOD(tidyNode, isHtml);
CREX_METHOD(tidyNode, isText);
CREX_METHOD(tidyNode, isJste);
CREX_METHOD(tidyNode, isAsp);
CREX_METHOD(tidyNode, isCrx);
CREX_METHOD(tidyNode, getParent);


static const crex_function_entry ext_functions[] = {
	CREX_FE(tidy_parse_string, arginfo_tidy_parse_string)
	CREX_FE(tidy_get_error_buffer, arginfo_tidy_get_error_buffer)
	CREX_FE(tidy_get_output, arginfo_tidy_get_output)
	CREX_FE(tidy_parse_file, arginfo_tidy_parse_file)
	CREX_FE(tidy_clean_repair, arginfo_tidy_clean_repair)
	CREX_FE(tidy_repair_string, arginfo_tidy_repair_string)
	CREX_FE(tidy_repair_file, arginfo_tidy_repair_file)
	CREX_FE(tidy_diagnose, arginfo_tidy_diagnose)
	CREX_FE(tidy_get_release, arginfo_tidy_get_release)
#if defined(HAVE_TIDYOPTGETDOC)
	CREX_FE(tidy_get_opt_doc, arginfo_tidy_get_opt_doc)
#endif
	CREX_FE(tidy_get_config, arginfo_tidy_get_config)
	CREX_FE(tidy_get_status, arginfo_tidy_get_status)
	CREX_FE(tidy_get_html_ver, arginfo_tidy_get_html_ver)
	CREX_FE(tidy_is_xhtml, arginfo_tidy_is_xhtml)
	CREX_FE(tidy_is_xml, arginfo_tidy_is_xml)
	CREX_FE(tidy_error_count, arginfo_tidy_error_count)
	CREX_FE(tidy_warning_count, arginfo_tidy_warning_count)
	CREX_FE(tidy_access_count, arginfo_tidy_access_count)
	CREX_FE(tidy_config_count, arginfo_tidy_config_count)
	CREX_FE(tidy_getopt, arginfo_tidy_getopt)
	CREX_FE(tidy_get_root, arginfo_tidy_get_root)
	CREX_FE(tidy_get_html, arginfo_tidy_get_html)
	CREX_FE(tidy_get_head, arginfo_tidy_get_head)
	CREX_FE(tidy_get_body, arginfo_tidy_get_body)
	CREX_FE_END
};


static const crex_function_entry class_tidy_methods[] = {
	CREX_ME(tidy, __main, arginfo_class_tidy___main, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(getOpt, tidy_getopt, arginfo_class_tidy_getOpt, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(cleanRepair, tidy_clean_repair, arginfo_class_tidy_cleanRepair, CREX_ACC_PUBLIC)
	CREX_ME(tidy, parseFile, arginfo_class_tidy_parseFile, CREX_ACC_PUBLIC)
	CREX_ME(tidy, parseString, arginfo_class_tidy_parseString, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(repairString, tidy_repair_string, arginfo_class_tidy_repairString, CREX_ACC_PUBLIC|CREX_ACC_STATIC)
	CREX_ME_MAPPING(repairFile, tidy_repair_file, arginfo_class_tidy_repairFile, CREX_ACC_PUBLIC|CREX_ACC_STATIC)
	CREX_ME_MAPPING(diagnose, tidy_diagnose, arginfo_class_tidy_diagnose, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(getRelease, tidy_get_release, arginfo_class_tidy_getRelease, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(getConfig, tidy_get_config, arginfo_class_tidy_getConfig, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(getStatus, tidy_get_status, arginfo_class_tidy_getStatus, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(getHtmlVer, tidy_get_html_ver, arginfo_class_tidy_getHtmlVer, CREX_ACC_PUBLIC)
#if defined(HAVE_TIDYOPTGETDOC)
	CREX_ME_MAPPING(getOptDoc, tidy_get_opt_doc, arginfo_class_tidy_getOptDoc, CREX_ACC_PUBLIC)
#endif
	CREX_ME_MAPPING(isXhtml, tidy_is_xhtml, arginfo_class_tidy_isXhtml, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(isXml, tidy_is_xml, arginfo_class_tidy_isXml, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(root, tidy_get_root, arginfo_class_tidy_root, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(head, tidy_get_head, arginfo_class_tidy_head, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(html, tidy_get_html, arginfo_class_tidy_html, CREX_ACC_PUBLIC)
	CREX_ME_MAPPING(body, tidy_get_body, arginfo_class_tidy_body, CREX_ACC_PUBLIC)
	CREX_FE_END
};


static const crex_function_entry class_tidyNode_methods[] = {
	CREX_ME(tidyNode, __main, arginfo_class_tidyNode___main, CREX_ACC_PRIVATE)
	CREX_ME(tidyNode, hasChildren, arginfo_class_tidyNode_hasChildren, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, hasSiblings, arginfo_class_tidyNode_hasSiblings, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isComment, arginfo_class_tidyNode_isComment, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isHtml, arginfo_class_tidyNode_isHtml, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isText, arginfo_class_tidyNode_isText, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isJste, arginfo_class_tidyNode_isJste, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isAsp, arginfo_class_tidyNode_isAsp, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, isCrx, arginfo_class_tidyNode_isCrx, CREX_ACC_PUBLIC)
	CREX_ME(tidyNode, getParent, arginfo_class_tidyNode_getParent, CREX_ACC_PUBLIC)
	CREX_FE_END
};
...
static void register_tidy_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("TIDY_NODETYPE_CRX", TidyNode_Crx, CONST_PERSISTENT);
...
static crex_class_entry *register_class_tidy(void)
{
	...
	crex_string *property_errorBuffer_name = crex_string_init("errorBuffer", sizeof("errorBuffer") - 1, 1);
	crex_declare_typed_property(class_entry, property_errorBuffer_name, &property_errorBuffer_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_STRING|MAY_BE_NULL));
	crex_string_release(property_errorBuffer_name);

	zval property_value_default_value;
	ZVAL_NULL(&property_value_default_value);
	crex_string *property_value_name = crex_string_init("value", sizeof("value") - 1, 1);
	crex_declare_typed_property(class_entry, property_value_name, &property_value_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_STRING|MAY_BE_NULL));
	crex_string_release(property_value_name);

	return class_entry;
}

static crex_class_entry *register_class_tidyNode(void)
{
	crex_class_entry ce, *class_entry;
	...
	crex_string *property_value_name = crex_string_init("value", sizeof("value") - 1, 1);
	crex_declare_typed_property(class_entry, property_value_name, &property_value_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_STRING));
	crex_string_release(property_value_name);

	zval property_name_default_value;
	ZVAL_UNDEF(&property_name_default_value);
	crex_string *property_name_name = crex_string_init("name", sizeof("name") - 1, 1);
	crex_declare_typed_property(class_entry, property_name_name, &property_name_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_STRING));
	...
	crex_declare_typed_property(class_entry, property_type_name, &property_type_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	...
	crex_declare_typed_property(class_entry, property_line_name, &property_line_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	crex_string_release(property_line_name);

	zval property_column_default_value;
	ZVAL_UNDEF(&property_column_default_value);
	crex_string *property_column_name = crex_string_init("column", sizeof("column") - 1, 1);
	crex_declare_typed_property(class_entry, property_column_name, &property_column_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	crex_string_release(property_column_name);

	zval property_proprietary_default_value;
	ZVAL_UNDEF(&property_proprietary_default_value);
	crex_string *property_proprietary_name = crex_string_init("proprietary", sizeof("proprietary") - 1, 1);
	crex_declare_typed_property(class_entry, property_proprietary_name, &property_proprietary_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_BOOL));
	crex_string_release(property_proprietary_name);

	zval property_id_default_value;
	ZVAL_UNDEF(&property_id_default_value);
	crex_string *property_id_name = crex_string_init("id", sizeof("id") - 1, 1);
	crex_declare_typed_property(class_entry, property_id_name, &property_id_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG|MAY_BE_NULL));
	crex_string_release(property_id_name);

	zval property_attribute_default_value;
	ZVAL_UNDEF(&property_attribute_default_value);
	crex_string *property_attribute_name = crex_string_init("attribute", sizeof("attribute") - 1, 1);
	crex_declare_typed_property(class_entry, property_attribute_name, &property_attribute_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_ARRAY|MAY_BE_NULL));
	crex_string_release(property_attribute_name);

	zval property_child_default_value;
	ZVAL_UNDEF(&property_child_default_value);
	crex_string *property_child_name = crex_string_init("child", sizeof("child") - 1, 1);
	crex_declare_typed_property(class_entry, property_child_name, &property_child_default_value, CREX_ACC_PUBLIC|CREX_ACC_READONLY, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_ARRAY|MAY_BE_NULL));
	crex_string_release(property_child_name);
