...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_set_streams_context, 0, 1, IS_VOID, 0)
	CREX_ARG_INFO(0, context)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_use_internal_errors, 0, 0, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, use_errors, _IS_BOOL, 1, "null")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_OBJ_TYPE_MASK_EX(arginfo_libxml_get_last_error, 0, 0, LibXMLError, MAY_BE_FALSE)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_get_errors, 0, 0, IS_ARRAY, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_clear_errors, 0, 0, IS_VOID, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_disable_entity_loader, 0, 0, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, disable, _IS_BOOL, 0, "true")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_set_external_entity_loader, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, resolver_function, IS_CALLABLE, 1)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_libxml_get_external_entity_loader, 0, 0, IS_CALLABLE, 1)
CREX_END_ARG_INFO()


CREX_FUNCTION(libxml_set_streams_context);
CREX_FUNCTION(libxml_use_internal_errors);
CREX_FUNCTION(libxml_get_last_error);
CREX_FUNCTION(libxml_get_errors);
CREX_FUNCTION(libxml_clear_errors);
CREX_FUNCTION(libxml_disable_entity_loader);
CREX_FUNCTION(libxml_set_external_entity_loader);
CREX_FUNCTION(libxml_get_external_entity_loader);


static const crex_function_entry ext_functions[] = {
	CREX_FE(libxml_set_streams_context, arginfo_libxml_set_streams_context)
	CREX_FE(libxml_use_internal_errors, arginfo_libxml_use_internal_errors)
	CREX_FE(libxml_get_last_error, arginfo_libxml_get_last_error)
	CREX_FE(libxml_get_errors, arginfo_libxml_get_errors)
	CREX_FE(libxml_clear_errors, arginfo_libxml_clear_errors)
	CREX_DEP_FE(libxml_disable_entity_loader, arginfo_libxml_disable_entity_loader)
	CREX_FE(libxml_set_external_entity_loader, arginfo_libxml_set_external_entity_loader)
	CREX_FE(libxml_get_external_entity_loader, arginfo_libxml_get_external_entity_loader)
	CREX_FE_END
};


static const crex_function_entry class_LibXMLError_methods[] = {
	CREX_FE_END
};
...
static void register_libxml_symbols(int module_number)
{
	...
	REGISTER_STRING_CONSTANT("LIBXML_LOADED_VERSION", CRX_LIBXML_LOADED_VERSION, CONST_PERSISTENT);
...
static crex_class_entry *register_class_LibXMLError(void)
{
	...
	crex_string *property_level_name = crex_string_init("level", sizeof("level") - 1, 1);
	crex_declare_typed_property(class_entry, property_level_name, &property_level_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	crex_string_release(property_level_name);

	zval property_code_default_value;
	ZVAL_UNDEF(&property_code_default_value);
	crex_string *property_code_name = crex_string_init("code", sizeof("code") - 1, 1);
	crex_declare_typed_property(class_entry, property_code_name, &property_code_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	...
	crex_declare_typed_property(class_entry, property_column_name, &property_column_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_LONG));
	...
	crex_declare_typed_property(class_entry, property_file_name, &property_file_default_value, CREX_ACC_PUBLIC, NULL, (crex_type) CREX_TYPE_INIT_MASK(MAY_BE_STRING));
