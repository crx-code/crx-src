...
#define SDNCAL_H
/*
 * This code has been modified for use with CRX
...
void SdnToGregorian(crex_long sdn, int *pYear, int *pMonth, int *pDay);
crex_long GregorianToSdn(int year, int month, int day);
extern const char * const MonthNameShort[13];
extern const char * const MonthNameLong[13];

/* Julian calendar conversions. */
void SdnToJulian(crex_long sdn, int *pYear, int *pMonth, int *pDay);
crex_long JulianToSdn(int year, int month, int day);

/* Jewish calendar conversions. */
void SdnToJewish(crex_long sdn, int *pYear, int *pMonth, int *pDay);
crex_long JewishToSdn(int year, int month, int day);
...
void SdnToFrench(crex_long sdn, int *pYear, int *pMonth, int *pDay);
crex_long FrenchToSdn(int inputYear, int inputMonth, int inputDay);
