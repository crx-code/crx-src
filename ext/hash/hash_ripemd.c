...
/* Heavily borrowed from md5.c & sha1.c of CRX archival fame
   Note that ripemd laughs in the face of logic and uses
   little endian byte ordering */

#include "crx_hash.h"
#include "crx_hash_ripemd.h"

const crx_hash_ops crx_hash_ripemd128_ops = {
	"ripemd128",
	(crx_hash_init_func_t) CRX_RIPEMD128Init,
	(crx_hash_update_func_t) CRX_RIPEMD128Update,
	(crx_hash_final_func_t) CRX_RIPEMD128Final,
	crx_hash_copy,
	crx_hash_serialize,
	...
	16,
	64,
	sizeof(CRX_RIPEMD128_CTX),
	1
};

const crx_hash_ops crx_hash_ripemd160_ops = {
	"ripemd160",
	(crx_hash_init_func_t) CRX_RIPEMD160Init,
	(crx_hash_update_func_t) CRX_RIPEMD160Update,
	(crx_hash_final_func_t) CRX_RIPEMD160Final,
	crx_hash_copy,
	crx_hash_serialize,
	crx_hash_unserialize,
	CRX_RIPEMD160_SPEC,
	20,
	64,
	sizeof(CRX_RIPEMD160_CTX),
	1
};

const crx_hash_ops crx_hash_ripemd256_ops = {
	"ripemd256",
	(crx_hash_init_func_t) CRX_RIPEMD256Init,
	(crx_hash_update_func_t) CRX_RIPEMD256Update,
	(crx_hash_final_func_t) CRX_RIPEMD256Final,
	crx_hash_copy,
	crx_hash_serialize,
	crx_hash_unserialize,
	CRX_RIPEMD256_SPEC,
	32,
	64,
	sizeof(CRX_RIPEMD256_CTX),
	1
};

const crx_hash_ops crx_hash_ripemd320_ops = {
	"ripemd320",
	(crx_hash_init_func_t) CRX_RIPEMD320Init,
	(crx_hash_update_func_t) CRX_RIPEMD320Update,
	(crx_hash_final_func_t) CRX_RIPEMD320Final,
	crx_hash_copy,
	crx_hash_serialize,
	crx_hash_unserialize,
	CRX_RIPEMD320_SPEC,
 ...
 */
CRX_HASH_API void CRX_RIPEMD128Init(CRX_RIPEMD128_CTX * context, CREX_ATTRIBUTE_UNUSED HashTable *args)
{
 ...
 */
CRX_HASH_API void CRX_RIPEMD256Init(CRX_RIPEMD256_CTX * context, CREX_ATTRIBUTE_UNUSED HashTable *args)
{
	context->count[0] = context->count[1] = 0;
	/* Load magic initialization constants.
	 */
 ...
 */
CRX_HASH_API void CRX_RIPEMD160Init(CRX_RIPEMD160_CTX * context, CREX_ATTRIBUTE_UNUSED HashTable *args)
{
	context->count[0] = context->count[1] = 0;
	/* Load magic initialization constants.
	 */
 ...
 */
CRX_HASH_API void CRX_RIPEMD320Init(CRX_RIPEMD320_CTX * context, CREX_ATTRIBUTE_UNUSED HashTable *args)
{
	context->count[0] = context->count[1] = 0;
	/* Load magic initialization constants.
	 */
...
/* {{{ CRX_RIPEMD128Update
   ...
   context.
 */
CRX_HASH_API void CRX_RIPEMD128Update(CRX_RIPEMD128_CTX * context, const unsigned char *input, size_t inputLen)
{
...
/* {{{ CRX_RIPEMD256Update
   ...
   context.
 */
CRX_HASH_API void CRX_RIPEMD256Update(CRX_RIPEMD256_CTX * context, const unsigned char *input, size_t inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ CRX_RIPEMD160Update
   ...
   context.
 */
CRX_HASH_API void CRX_RIPEMD160Update(CRX_RIPEMD160_CTX * context, const unsigned char *input, size_t inputLen)
{
	unsigned int i, index, partLen;
...
/* {{{ CRX_RIPEMD320Update
   ...
   context.
 */
CRX_HASH_API void CRX_RIPEMD320Update(CRX_RIPEMD320_CTX * context, const unsigned char *input, size_t inputLen)
{
	unsigned int i, index, partLen;
 ...
 */
CRX_HASH_API void CRX_RIPEMD128Final(unsigned char digest[16], CRX_RIPEMD128_CTX * context)
{
	...
	CRX_RIPEMD128Update(context, PADDING, padLen);

	/* Append length (before padding) */
	CRX_RIPEMD128Update(context, bits, 8);
...
/* {{{ CRX_RIPEMD256Final
   ...
   the message digest and zeroizing the context.
 */
CRX_HASH_API void CRX_RIPEMD256Final(unsigned char digest[32], CRX_RIPEMD256_CTX * context)
{
	unsigned char bits[8];
	unsigned int index, padLen;
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	CRX_RIPEMD256Update(context, PADDING, padLen);

	/* Append length (before padding) */
	CRX_RIPEMD256Update(context, bits, 8);
...
/* {{{ CRX_RIPEMD160Final
   ...
   the message digest and zeroizing the context.
 */
CRX_HASH_API void CRX_RIPEMD160Final(unsigned char digest[20], CRX_RIPEMD160_CTX * context)
{
	unsigned char bits[8];
	unsigned int index, padLen;
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	CRX_RIPEMD160Update(context, PADDING, padLen);

	/* Append length (before padding) */
	CRX_RIPEMD160Update(context, bits, 8);
...
/* {{{ CRX_RIPEMD320Final
   ...
   the message digest and zeroizing the context.
 */
CRX_HASH_API void CRX_RIPEMD320Final(unsigned char digest[40], CRX_RIPEMD320_CTX * context)
{
	unsigned char bits[8];
	unsigned int index, padLen;
	...
	index = (unsigned int) ((context->count[0] >> 3) & 0x3f);
	padLen = (index < 56) ? (56 - index) : (120 - index);
	CRX_RIPEMD320Update(context, PADDING, padLen);

	/* Append length (before padding) */
	CRX_RIPEMD320Update(context, bits, 8);
