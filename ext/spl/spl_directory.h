...
extern CRXAPI crex_class_entry *spl_ce_SplFileInfo;
extern CRXAPI crex_class_entry *spl_ce_DirectoryIterator;
extern CRXAPI crex_class_entry *spl_ce_FilesystemIterator;
extern CRXAPI crex_class_entry *spl_ce_RecursiveDirectoryIterator;
extern CRXAPI crex_class_entry *spl_ce_GlobIterator;
extern CRXAPI crex_class_entry *spl_ce_SplFileObject;
extern CRXAPI crex_class_entry *spl_ce_SplTempFileObject;
...
struct _spl_filesystem_object {
	...
	crex_string        *path;
	crex_string        *orig_path;
	crex_string        *file_name;
	SPL_FS_OBJ_TYPE    type;
	crex_long               flags;
	crex_class_entry   *file_class;
	crex_class_entry   *info_class;
	union {
		struct {
			crx_stream         *dirp;
			crex_string        *sub_path;
			int                index;
			crex_function      *func_rewind;
			crex_function      *func_next;
			crex_function      *func_valid;
		...
		struct {
			...
			zval               *zcontext;
			crex_string        *open_mode;
			zval               current_zval;
			char               *current_line;
			size_t             current_line_len;
			size_t             max_line_len;
			crex_long               current_line_num;
			zval               zresource;
			crex_function      *func_getCurr;
			char               delimiter;
			char               enclosure;
			int                escape;
		} file;
