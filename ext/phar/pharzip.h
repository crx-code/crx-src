...
typedef struct _crxa_zip_file_header {
...
} crxa_zip_file_header;

/* unused in this release */
typedef struct _crxa_zip_file_datadesc {
...
*/
#define CRXA_ZIP_COMP_NONE    0
#define CRXA_ZIP_COMP_DEFLATE 8
#define CRXA_ZIP_COMP_BZIP2   12
...
typedef struct _crxa_zip_extra_field_header {
	char tag[2];
	char size[2];
} crxa_zip_extra_field_header;

typedef struct _crxa_zip_unix3 {
...
typedef struct _crxa_zip_central_dir_file {
...
} crxa_zip_central_dir_file;

typedef struct _crxa_zip_dir_signature {
	char signature[4];  /* header signature                4 bytes  (0x05054b50) */
	char size[2];    /* size of data                    2 bytes */
} crxa_zip_dir_signature;

/* unused in this release */
typedef struct _crxa_zip64_dir_end {
...
/* unused in this release */
typedef struct _crxa_zip64_dir_locator {
...
} crxa_zip64_dir_locator;

typedef struct _crxa_zip_dir_end {
