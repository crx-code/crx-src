...
#ifndef CRX_PDO_PGSQL_INT_H
#define CRX_PDO_PGSQL_INT_H

#include <libpq-fe.h>
#include <libpq/libpq-fs.h>
#include <crx.h>

#define CRX_PDO_PGSQL_CONNECTION_FAILURE_SQLSTATE "08006"
...
crx_stream *pdo_pgsql_create_lob_stream(zval *pdh, int lfd, Oid oid);
extern const crx_stream_ops pdo_pgsql_lob_stream_ops;

void pdo_libpq_version(char *buf, size_t len);
void pdo_pgsql_close_lob_streams(pdo_dbh_t *dbh);

#endif /* CRX_PDO_PGSQL_INT_H */
