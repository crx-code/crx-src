...
CRXAPI void mysqlnd_stats_init(MYSQLND_STATS ** stats, const size_t statistic_count, const bool persistent);
CRXAPI void mysqlnd_stats_end(MYSQLND_STATS * stats, const bool persistent);

CRXAPI void mysqlnd_fill_stats_hash(const MYSQLND_STATS * const stats, const MYSQLND_STRING * names, zval *return_value CREX_FILE_LINE_DC);
