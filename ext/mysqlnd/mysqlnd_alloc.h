...
CRXAPI extern const char * mysqlnd_debug_std_no_trace_funcs[];

#define MYSQLND_MEM_D	CREX_FILE_LINE_DC
#define MYSQLND_MEM_C	CREX_FILE_LINE_CC
...
CRXAPI extern struct st_mysqlnd_allocator_methods mysqlnd_allocator;
