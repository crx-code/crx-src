...
/*
  ...
  Andrey Hristov <andrey@crx.net> . The additions are in the public domain and
...
#define sint3korr(A)    ((int32_t) ((((crex_uchar) (A)[2]) & 128) ? \
                   (((uint32_t) 255L << 24) | \
                   (((uint32_t) (crex_uchar) (A)[2]) << 16) |\
                   (((uint32_t) (crex_uchar) (A)[1]) << 8) | \
                    ((uint32_t) (crex_uchar) (A)[0])) : \
                   (((uint32_t) (crex_uchar) (A)[2]) << 16) |\
                   (((uint32_t) (crex_uchar) (A)[1]) << 8) | \
                    ((uint32_t) (crex_uchar) (A)[0])))
#define sint4korr(A)  (*((crex_long *) (A)))

#define uint2korr(A)  (*((uint16_t *) (A)))
#define uint3korr(A)  (uint32_t) (((uint32_t) ((crex_uchar) (A)[0])) +\
                               (((uint32_t) ((crex_uchar) (A)[1])) << 8) +\
                               (((uint32_t) ((crex_uchar) (A)[2])) << 16))
#define uint4korr(A)  (*((crex_ulong *) (A)))
...
#define int3store(T,A)   { \
                  *(T)=  (crex_uchar) ((A));\
                  *(T+1)=(crex_uchar) (((uint32_t) (A) >> 8));\
                  *(T+2)=(crex_uchar) (((A) >> 16)); }
#define int4store(T,A)    *((crex_long *) (T))= (crex_long) (A)
#define int5store(T,A)    { \
              *((crex_uchar *)(T))= (crex_uchar)((A));\
              *(((crex_uchar *)(T))+1)=(crex_uchar) (((A) >> 8));\
              *(((crex_uchar *)(T))+2)=(crex_uchar) (((A) >> 16));\
              *(((crex_uchar *)(T))+3)=(crex_uchar) (((A) >> 24)); \
              *(((crex_uchar *)(T))+4)=(crex_uchar) (((A) >> 32)); }
...
#define float8get(V,M)    { ((float8get_union *)&(V))->m[0] = *((crex_long*) (M)); \
                            ((float8get_union *)&(V))->m[1] = *(((crex_long*) (M))+1); }
#define float8store(T,V) { *((crex_long *) (T))     = ((float8get_union *)&(V))->m[0]; \
                           *(((crex_long *) (T))+1) = ((float8get_union *)&(V))->m[1]; }
...
#ifndef sint2korr
#define sint2korr(A)    (int16_t) (((int16_t) ((crex_uchar) (A)[0])) +\
...
#define uint2korr(A)  (uint16_t) (((uint16_t) ((crex_uchar) (A)[0])) +\
                               ((uint16_t) ((crex_uchar) (A)[1]) << 8))
#define uint3korr(A)  (uint32_t) (((uint32_t) ((crex_uchar) (A)[0])) +\
                               (((uint32_t) ((crex_uchar) (A)[1])) << 8) +\
                               (((uint32_t) ((crex_uchar) (A)[2])) << 16))
#define uint4korr(A)  (uint32_t) (((uint32_t) ((crex_uchar) (A)[0])) +\
                               (((uint32_t) ((crex_uchar) (A)[1])) << 8) +\
                               (((uint32_t) ((crex_uchar) (A)[2])) << 16) +\
                               (((uint32_t) ((crex_uchar) (A)[3])) << 24))

#define uint8korr(A)	((uint64_t)(((uint32_t) ((crex_uchar) (A)[0])) +\
									(((uint32_t) ((crex_uchar) (A)[1])) << 8) +\
									(((uint32_t) ((crex_uchar) (A)[2])) << 16) +\
									(((uint32_t) ((crex_uchar) (A)[3])) << 24)) +\
									(((uint64_t) (((uint32_t) ((crex_uchar) (A)[4])) +\
									(((uint32_t) ((crex_uchar) (A)[5])) << 8) +\
									(((uint32_t) ((crex_uchar) (A)[6])) << 16) +\
									(((uint32_t) ((crex_uchar) (A)[7])) << 24))) << 32))


#define int2store(T,A)  do { uint32_t def_temp= (uint32_t) (A) ;\
                  *((crex_uchar*) (T))  =  (crex_uchar)(def_temp); \
                  *((crex_uchar*) (T+1)) = (crex_uchar)((def_temp >> 8)); } while (0)
