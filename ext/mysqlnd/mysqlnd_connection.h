...
CRXAPI extern const char * const mysqlnd_out_of_sync;
CRXAPI extern const char * const mysqlnd_server_gone;
CRXAPI extern const char * const mysqlnd_out_of_memory;
...
CRXAPI void mysqlnd_error_info_init(MYSQLND_ERROR_INFO * const info, const bool persistent);
CRXAPI void	mysqlnd_error_info_free_contents(MYSQLND_ERROR_INFO * const info);
...
CRXAPI void mysqlnd_connection_state_init(struct st_mysqlnd_connection_state * const state);
