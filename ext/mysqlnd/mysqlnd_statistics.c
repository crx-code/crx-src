...
CRXAPI void
mysqlnd_fill_stats_hash(const MYSQLND_STATS * const stats, const MYSQLND_STRING * names, zval *return_value CREX_FILE_LINE_DC)
{
	unsigned int i;
...
CRXAPI void
_mysqlnd_get_client_stats(MYSQLND_STATS * stats_ptr, zval *return_value CREX_FILE_LINE_DC)
{
	MYSQLND_STATS stats;
	...
	mysqlnd_fill_stats_hash(stats_ptr, mysqlnd_stats_values_names, return_value CREX_FILE_LINE_CC);
	DBG_VOID_RETURN;
}
/* }}} */
