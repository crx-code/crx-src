...
#ifndef CRX_ENCODING_H
#define CRX_ENCODING_H
...
#define C_VAR_ENC_TYPE_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 0))
#define C_VAR_ENC_VALUE_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 1))
#define C_VAR_ENC_STYPE_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 2))
#define C_VAR_ENC_NS_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 3))
#define C_VAR_ENC_NAME_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 4))
#define C_VAR_ENC_NAMENS_P(zv) crx_soap_deref(OBJ_PROP_NUM(C_OBJ_P(zv), 5))
