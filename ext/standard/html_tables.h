...
***************************************************************************
** Please change html_tables/html_table_gen.crx instead and then         **
...
static const entity_cp_map ht_bucket_html5_29F[] = { {"UnderBracket", 12, 0x023B5, 0}, {"ovbar", 5, 0x0233D, 0}, {"ucrxapoonright", 14, 0x021BE, 0}, {NULL, 0, 0, 0} };
...
static const entity_cp_map ht_bucket_html5_D6C[] = { {"RightTeeArrow", 13, 0x021A6, 0}, {"Yuml", 4, 0x00178, 0}, {"target", 6, 0x02316, 0}, {"ucrxapoonleft", 13, 0x021BF, 0}, {NULL, 0, 0, 0} };
