...
CREDIT_LINE("CRX Archive", "Gregory Beaver, Marcus Boerger");
CREDIT_LINE("CRX Data Objects", "Wez Furlong, Marcus Boerger, Sterling Hughes, George Schlossnagle, Ilia Alshanetsky");
CREDIT_LINE("CRX hash", "Sara Golemon, Rasmus Lerdorf, Stefan Esser, Michael Wallner, Scott MacVicar");
