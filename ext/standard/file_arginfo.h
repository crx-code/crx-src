...
static void register_file_symbols(int module_number)
{
	...
	REGISTER_LONG_CONSTANT("LOCK_SH", CRX_LOCK_SH, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LOCK_EX", CRX_LOCK_EX, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LOCK_UN", CRX_LOCK_UN, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("LOCK_NB", CRX_LOCK_NB, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_CONNECT", CRX_STREAM_NOTIFY_CONNECT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_AUTH_REQUIRED", CRX_STREAM_NOTIFY_AUTH_REQUIRED, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_AUTH_RESULT", CRX_STREAM_NOTIFY_AUTH_RESULT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_MIME_TYPE_IS", CRX_STREAM_NOTIFY_MIME_TYPE_IS, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_FILE_SIZE_IS", CRX_STREAM_NOTIFY_FILE_SIZE_IS, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_REDIRECTED", CRX_STREAM_NOTIFY_REDIRECTED, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_PROGRESS", CRX_STREAM_NOTIFY_PROGRESS, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_FAILURE", CRX_STREAM_NOTIFY_FAILURE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_COMPLETED", CRX_STREAM_NOTIFY_COMPLETED, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_RESOLVE", CRX_STREAM_NOTIFY_RESOLVE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_SEVERITY_INFO", CRX_STREAM_NOTIFY_SEVERITY_INFO, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_SEVERITY_WARN", CRX_STREAM_NOTIFY_SEVERITY_WARN, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_NOTIFY_SEVERITY_ERR", CRX_STREAM_NOTIFY_SEVERITY_ERR, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_FILTER_READ", CRX_STREAM_FILTER_READ, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_FILTER_WRITE", CRX_STREAM_FILTER_WRITE, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_FILTER_ALL", CRX_STREAM_FILTER_ALL, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_CLIENT_PERSISTENT", CRX_STREAM_CLIENT_PERSISTENT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_CLIENT_ASYNC_CONNECT", CRX_STREAM_CLIENT_ASYNC_CONNECT, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("STREAM_CLIENT_CONNECT", CRX_STREAM_CLIENT_CONNECT, CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("FILE_USE_INCLUDE_PATH", CRX_FILE_USE_INCLUDE_PATH, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILE_IGNORE_NEW_LINES", CRX_FILE_IGNORE_NEW_LINES, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILE_SKIP_EMPTY_LINES", CRX_FILE_SKIP_EMPTY_LINES, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILE_APPEND", CRX_FILE_APPEND, CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("FILE_NO_DEFAULT_CONTEXT", CRX_FILE_NO_DEFAULT_CONTEXT, CONST_PERSISTENT);
