...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_fork, 0, 0, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_waitpid, 0, 2, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, process_id, IS_LONG, 0)
	CREX_ARG_INFO(1, status)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, flags, IS_LONG, 0, "0")
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, resource_usage, "[]")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_wait, 0, 1, IS_LONG, 0)
	CREX_ARG_INFO(1, status)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, flags, IS_LONG, 0, "0")
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, resource_usage, "[]")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_signal, 0, 2, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, signal, IS_LONG, 0)
	CREX_ARG_INFO(0, handler)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, restart_syscalls, _IS_BOOL, 0, "true")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_INFO_EX(arginfo_pcntl_signal_get_handler, 0, 0, 1)
	CREX_ARG_TYPE_INFO(0, signal, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_signal_dispatch, 0, 0, _IS_BOOL, 0)
CREX_END_ARG_INFO()

#if defined(HAVE_SIGPROCMASK)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_sigprocmask, 0, 2, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, mode, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, signals, IS_ARRAY, 0)
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, old_signals, "null")
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_pcntl_sigwaitinfo, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, signals, IS_ARRAY, 0)
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, info, "[]")
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_pcntl_sigtimedwait, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, signals, IS_ARRAY, 0)
	CREX_ARG_INFO_WITH_DEFAULT_VALUE(1, info, "[]")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, seconds, IS_LONG, 0, "0")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, nanoseconds, IS_LONG, 0, "0")
CREX_END_ARG_INFO()
#endif

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_wifexited, 0, 1, _IS_BOOL, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_wifcontinued, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, status, IS_LONG, 0)
CREX_END_ARG_INFO()
#endif
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_pcntl_wexitstatus, 0, 1, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO(0, status, IS_LONG, 0)
CREX_END_ARG_INFO()
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_exec, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, path, IS_STRING, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, args, IS_ARRAY, 0, "[]")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, env_vars, IS_ARRAY, 0, "[]")
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_alarm, 0, 1, IS_LONG, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_pcntl_getpriority, 0, 0, MAY_BE_LONG|MAY_BE_FALSE)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, process_id, IS_LONG, 1, "null")
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_LONG, 0, "PRIO_PROCESS")
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_SETPRIORITY)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_setpriority, 0, 1, _IS_BOOL, 0)
...
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_strerror, 0, 1, IS_STRING, 0)
	CREX_ARG_TYPE_INFO(0, error_code, IS_LONG, 0)
CREX_END_ARG_INFO()

CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_async_signals, 0, 0, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, enable, _IS_BOOL, 1, "null")
CREX_END_ARG_INFO()

#if defined(HAVE_UNSHARE)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_unshare, 0, 1, _IS_BOOL, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_RFORK)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_rfork, 0, 1, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
	CREX_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, signal, IS_LONG, 0, "0")
CREX_END_ARG_INFO()
#endif

#if defined(HAVE_FORKX)
CREX_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_pcntl_forkx, 0, 1, IS_LONG, 0)
	CREX_ARG_TYPE_INFO(0, flags, IS_LONG, 0)
CREX_END_ARG_INFO()
#endif


CREX_FUNCTION(pcntl_fork);
CREX_FUNCTION(pcntl_waitpid);
CREX_FUNCTION(pcntl_wait);
CREX_FUNCTION(pcntl_signal);
CREX_FUNCTION(pcntl_signal_get_handler);
CREX_FUNCTION(pcntl_signal_dispatch);
#if defined(HAVE_SIGPROCMASK)
CREX_FUNCTION(pcntl_sigprocmask);
#endif
#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
CREX_FUNCTION(pcntl_sigwaitinfo);
#endif
#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
CREX_FUNCTION(pcntl_sigtimedwait);
#endif
CREX_FUNCTION(pcntl_wifexited);
CREX_FUNCTION(pcntl_wifstopped);
#if defined(HAVE_WCONTINUED)
CREX_FUNCTION(pcntl_wifcontinued);
#endif
CREX_FUNCTION(pcntl_wifsignaled);
CREX_FUNCTION(pcntl_wexitstatus);
CREX_FUNCTION(pcntl_wtermsig);
CREX_FUNCTION(pcntl_wstopsig);
CREX_FUNCTION(pcntl_exec);
CREX_FUNCTION(pcntl_alarm);
CREX_FUNCTION(pcntl_get_last_error);
#if defined(HAVE_GETPRIORITY)
CREX_FUNCTION(pcntl_getpriority);
#endif
#if defined(HAVE_SETPRIORITY)
CREX_FUNCTION(pcntl_setpriority);
#endif
CREX_FUNCTION(pcntl_strerror);
CREX_FUNCTION(pcntl_async_signals);
#if defined(HAVE_UNSHARE)
CREX_FUNCTION(pcntl_unshare);
#endif
#if defined(HAVE_RFORK)
CREX_FUNCTION(pcntl_rfork);
#endif
#if defined(HAVE_FORKX)
CREX_FUNCTION(pcntl_forkx);
#endif


static const crex_function_entry ext_functions[] = {
	CREX_FE(pcntl_fork, arginfo_pcntl_fork)
	CREX_FE(pcntl_waitpid, arginfo_pcntl_waitpid)
	CREX_FE(pcntl_wait, arginfo_pcntl_wait)
	CREX_FE(pcntl_signal, arginfo_pcntl_signal)
	CREX_FE(pcntl_signal_get_handler, arginfo_pcntl_signal_get_handler)
	CREX_FE(pcntl_signal_dispatch, arginfo_pcntl_signal_dispatch)
#if defined(HAVE_SIGPROCMASK)
	CREX_FE(pcntl_sigprocmask, arginfo_pcntl_sigprocmask)
#endif
#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
	CREX_FE(pcntl_sigwaitinfo, arginfo_pcntl_sigwaitinfo)
#endif
#if defined(HAVE_STRUCT_SIGINFO_T) && (defined(HAVE_SIGWAITINFO) && defined(HAVE_SIGTIMEDWAIT))
	CREX_FE(pcntl_sigtimedwait, arginfo_pcntl_sigtimedwait)
#endif
	CREX_FE(pcntl_wifexited, arginfo_pcntl_wifexited)
	CREX_FE(pcntl_wifstopped, arginfo_pcntl_wifstopped)
#if defined(HAVE_WCONTINUED)
	CREX_FE(pcntl_wifcontinued, arginfo_pcntl_wifcontinued)
#endif
	CREX_FE(pcntl_wifsignaled, arginfo_pcntl_wifsignaled)
	CREX_FE(pcntl_wexitstatus, arginfo_pcntl_wexitstatus)
	CREX_FE(pcntl_wtermsig, arginfo_pcntl_wtermsig)
	CREX_FE(pcntl_wstopsig, arginfo_pcntl_wstopsig)
	CREX_FE(pcntl_exec, arginfo_pcntl_exec)
	CREX_FE(pcntl_alarm, arginfo_pcntl_alarm)
	CREX_FE(pcntl_get_last_error, arginfo_pcntl_get_last_error)
	CREX_FALIAS(pcntl_errno, pcntl_get_last_error, arginfo_pcntl_errno)
#if defined(HAVE_GETPRIORITY)
	CREX_FE(pcntl_getpriority, arginfo_pcntl_getpriority)
#endif
#if defined(HAVE_SETPRIORITY)
	CREX_FE(pcntl_setpriority, arginfo_pcntl_setpriority)
#endif
	CREX_FE(pcntl_strerror, arginfo_pcntl_strerror)
	CREX_FE(pcntl_async_signals, arginfo_pcntl_async_signals)
#if defined(HAVE_UNSHARE)
	CREX_FE(pcntl_unshare, arginfo_pcntl_unshare)
#endif
#if defined(HAVE_RFORK)
	CREX_FE(pcntl_rfork, arginfo_pcntl_rfork)
#endif
#if defined(HAVE_FORKX)
	CREX_FE(pcntl_forkx, arginfo_pcntl_forkx)
#endif
	CREX_FE_END
};
