...
if test "$CRX_PCNTL" != "no"; then
  ...
  CRX_NEW_EXTENSION(pcntl, pcntl.c crx_signal.c, $ext_shared, cli, $PCNTL_CFLAGS -DCREX_ENABLE_STATIC_TSRMLS_CACHE=1)
fi
