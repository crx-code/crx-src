...
static int parse_declaration_specifiers(int sym, crex_ffi_dcl *dcl);
static int parse_specifier_qualifier_list(int sym, crex_ffi_dcl *dcl);
static int parse_type_qualifier_list(int sym, crex_ffi_dcl *dcl);
static int parse_type_qualifier(int sym, crex_ffi_dcl *dcl);
static int parse_type_specifier(int sym, crex_ffi_dcl *dcl);
static int parse_struct_or_union_specifier(int sym, crex_ffi_dcl *dcl);
static int parse_struct_contents(int sym, crex_ffi_dcl *dcl);
static int parse_struct_declaration(int sym, crex_ffi_dcl *struct_dcl);
static int parse_struct_declarator(int sym, crex_ffi_dcl *struct_dcl, crex_ffi_dcl *field_dcl);
static int parse_enum_specifier(int sym, crex_ffi_dcl *dcl);
static int parse_enumerator_list(int sym, crex_ffi_dcl *enum_dcl);
static int parse_enumerator(int sym, crex_ffi_dcl *enum_dcl, int64_t *min, int64_t *max, int64_t *last);
static int parse_declarator(int sym, crex_ffi_dcl *dcl, const char **name, size_t *name_len);
static int parse_abstract_declarator(int sym, crex_ffi_dcl *dcl);
static int parse_parameter_declarator(int sym, crex_ffi_dcl *dcl, const char **name, size_t *name_len);
static int parse_pointer(int sym, crex_ffi_dcl *dcl);
static int parse_array_or_function_declarators(int sym, crex_ffi_dcl *dcl, crex_ffi_dcl *nested_dcl);
static int parse_parameter_declaration(int sym, HashTable **args);
static int parse_type_name(int sym, crex_ffi_dcl *dcl);
static int parse_attributes(int sym, crex_ffi_dcl *dcl);
static int parse_attrib(int sym, crex_ffi_dcl *dcl);
static int parse_initializer(int sym);
static int parse_designation(int sym);
static int parse_expr_list(int sym);
static int parse_expression(int sym, crex_ffi_val *val);
static int parse_assignment_expression(int sym, crex_ffi_val *val);
static int parse_constant_expression(int sym, crex_ffi_val *val);
static int parse_conditional_expression(int sym, crex_ffi_val *val);
static int parse_logical_or_expression(int sym, crex_ffi_val *val);
static int parse_logical_and_expression(int sym, crex_ffi_val *val);
static int parse_inclusive_or_expression(int sym, crex_ffi_val *val);
static int parse_exclusive_or_expression(int sym, crex_ffi_val *val);
static int parse_and_expression(int sym, crex_ffi_val *val);
static int parse_equality_expression(int sym, crex_ffi_val *val);
static int parse_relational_expression(int sym, crex_ffi_val *val);
static int parse_shift_expression(int sym, crex_ffi_val *val);
static int parse_additive_expression(int sym, crex_ffi_val *val);
static int parse_multiplicative_expression(int sym, crex_ffi_val *val);
static int parse_cast_expression(int sym, crex_ffi_val *val);
static int parse_unary_expression(int sym, crex_ffi_val *val);
static int parse_ID(int sym, const char **name, size_t *name_len);
static int parse_OCTNUMBER(int sym, crex_ffi_val *val);
static int parse_DECNUMBER(int sym, crex_ffi_val *val);
static int parse_HEXNUMBER(int sym, crex_ffi_val *val);
static int parse_FLOATNUMBER(int sym, crex_ffi_val *val);
static int parse_STRING(int sym, crex_ffi_val *val);
static int parse_CHARACTER(int sym, crex_ffi_val *val);
...
static int check_nested_declarator_start(int sym) {
	...
	sym = get_sym();
	if ((sym == YY_ID) && (!crex_ffi_is_typedef_name((const char*)yy_text, yy_pos - yy_text))) {
		sym = check_ID(sym);
		if (sym == -1) {
			return -1;
		}
