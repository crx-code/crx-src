...
#define O_AL      { OP_AL,       SC_B     }
#define O_AX      { OP_AX,       SC_W     }
#define O_Av      { OP_A,        SC_V     }
#define O_C       { OP_C,        SC_NA    }
#define O_CL      { OP_CL,       SC_B     }
#define O_CS      { OP_CS,       SC_NA    }
#define O_CX      { OP_CX,       SC_W     }
#define O_D       { OP_D,        SC_NA    }
#define O_DL      { OP_DL,       SC_B     }
#define O_DS      { OP_DS,       SC_NA    }
#define O_DX      { OP_DX,       SC_W     }
#define O_E       { OP_E,        SC_NA    }
#define O_ES      { OP_ES,       SC_NA    }
#define O_Eb      { OP_E,        SC_B     }
#define O_Ed      { OP_E,        SC_D     }
#define O_Eq      { OP_E,        SC_Q     }
#define O_Ev      { OP_E,        SC_V     }
#define O_Ew      { OP_E,        SC_W     }
#define O_Ey      { OP_E,        SC_Y     }
#define O_Ez      { OP_E,        SC_Z     }
#define O_FS      { OP_FS,       SC_NA    }
#define O_Fv      { OP_F,        SC_V     }
#define O_G       { OP_G,        SC_NA    }
#define O_GS      { OP_GS,       SC_NA    }
#define O_Gb      { OP_G,        SC_B     }
#define O_Gd      { OP_G,        SC_D     }
#define O_Gq      { OP_G,        SC_Q     }
#define O_Gv      { OP_G,        SC_V     }
#define O_Gw      { OP_G,        SC_W     }
#define O_Gy      { OP_G,        SC_Y     }
#define O_Gz      { OP_G,        SC_Z     }
#define O_H       { OP_H,        SC_X     }
#define O_Hqq     { OP_H,        SC_QQ    }
#define O_Hx      { OP_H,        SC_X     }
#define O_I1      { OP_I1,       SC_NA    }
#define O_I3      { OP_I3,       SC_NA    }
#define O_Ib      { OP_I,        SC_B     }
#define O_Iv      { OP_I,        SC_V     }
#define O_Iw      { OP_I,        SC_W     }
#define O_Iz      { OP_I,        SC_Z     }
#define O_Jb      { OP_J,        SC_B     }
#define O_Jv      { OP_J,        SC_V     }
#define O_Jz      { OP_J,        SC_Z     }
#define O_L       { OP_L,        SC_O     }
#define O_Lx      { OP_L,        SC_X     }
#define O_M       { OP_M,        SC_NA    }
#define O_Mb      { OP_M,        SC_B     }
#define O_MbRd    { OP_MR,       SC_BD    }
#define O_MbRv    { OP_MR,       SC_BV    }
#define O_Md      { OP_M,        SC_D     }
#define O_MdRy    { OP_MR,       SC_DY    }
#define O_MdU     { OP_MU,       SC_DO    }
#define O_Mdq     { OP_M,        SC_DQ    }
#define O_Mo      { OP_M,        SC_O     }
#define O_Mq      { OP_M,        SC_Q     }
#define O_MqU     { OP_MU,       SC_QO    }
#define O_Ms      { OP_M,        SC_W     }
#define O_Mt      { OP_M,        SC_T     }
#define O_Mv      { OP_M,        SC_V     }
#define O_Mw      { OP_M,        SC_W     }
#define O_MwRd    { OP_MR,       SC_WD    }
#define O_MwRv    { OP_MR,       SC_WV    }
#define O_MwRy    { OP_MR,       SC_WY    }
#define O_MwU     { OP_MU,       SC_WO    }
#define O_N       { OP_N,        SC_Q     }
#define O_NONE    { OP_NONE,     SC_NA    }
#define O_Ob      { OP_O,        SC_B     }
#define O_Ov      { OP_O,        SC_V     }
#define O_Ow      { OP_O,        SC_W     }
#define O_P       { OP_P,        SC_Q     }
#define O_Q       { OP_Q,        SC_Q     }
#define O_R       { OP_R,        SC_RDQ   }
#define O_R0b     { OP_R0,       SC_B     }
#define O_R0v     { OP_R0,       SC_V     }
#define O_R0w     { OP_R0,       SC_W     }
#define O_R0y     { OP_R0,       SC_Y     }
#define O_R0z     { OP_R0,       SC_Z     }
#define O_R1b     { OP_R1,       SC_B     }
#define O_R1v     { OP_R1,       SC_V     }
#define O_R1w     { OP_R1,       SC_W     }
#define O_R1y     { OP_R1,       SC_Y     }
#define O_R1z     { OP_R1,       SC_Z     }
#define O_R2b     { OP_R2,       SC_B     }
#define O_R2v     { OP_R2,       SC_V     }
#define O_R2w     { OP_R2,       SC_W     }
#define O_R2y     { OP_R2,       SC_Y     }
#define O_R2z     { OP_R2,       SC_Z     }
#define O_R3b     { OP_R3,       SC_B     }
#define O_R3v     { OP_R3,       SC_V     }
#define O_R3w     { OP_R3,       SC_W     }
#define O_R3y     { OP_R3,       SC_Y     }
#define O_R3z     { OP_R3,       SC_Z     }
#define O_R4b     { OP_R4,       SC_B     }
#define O_R4v     { OP_R4,       SC_V     }
#define O_R4w     { OP_R4,       SC_W     }
#define O_R4y     { OP_R4,       SC_Y     }
#define O_R4z     { OP_R4,       SC_Z     }
#define O_R5b     { OP_R5,       SC_B     }
#define O_R5v     { OP_R5,       SC_V     }
#define O_R5w     { OP_R5,       SC_W     }
#define O_R5y     { OP_R5,       SC_Y     }
#define O_R5z     { OP_R5,       SC_Z     }
#define O_R6b     { OP_R6,       SC_B     }
#define O_R6v     { OP_R6,       SC_V     }
#define O_R6w     { OP_R6,       SC_W     }
#define O_R6y     { OP_R6,       SC_Y     }
#define O_R6z     { OP_R6,       SC_Z     }
#define O_R7b     { OP_R7,       SC_B     }
#define O_R7v     { OP_R7,       SC_V     }
#define O_R7w     { OP_R7,       SC_W     }
#define O_R7y     { OP_R7,       SC_Y     }
#define O_R7z     { OP_R7,       SC_Z     }
#define O_S       { OP_S,        SC_W     }
#define O_SS      { OP_SS,       SC_NA    }
#define O_ST0     { OP_ST0,      SC_NA    }
#define O_ST1     { OP_ST1,      SC_NA    }
#define O_ST2     { OP_ST2,      SC_NA    }
#define O_ST3     { OP_ST3,      SC_NA    }
#define O_ST4     { OP_ST4,      SC_NA    }
#define O_ST5     { OP_ST5,      SC_NA    }
#define O_ST6     { OP_ST6,      SC_NA    }
#define O_ST7     { OP_ST7,      SC_NA    }
#define O_U       { OP_U,        SC_O     }
#define O_Ux      { OP_U,        SC_X     }
#define O_V       { OP_V,        SC_DQ    }
#define O_Vdq     { OP_V,        SC_DQ    }
#define O_Vqq     { OP_V,        SC_QQ    }
#define O_Vsd     { OP_V,        SC_Q     }
#define O_Vx      { OP_V,        SC_X     }
#define O_W       { OP_W,        SC_DQ    }
#define O_Wdq     { OP_W,        SC_DQ    }
#define O_Wqq     { OP_W,        SC_QQ    }
#define O_Wsd     { OP_W,        SC_Q     }
#define O_Wx      { OP_W,        SC_X     }
#define O_eAX     { OP_eAX,      SC_Z     }
#define O_eCX     { OP_eCX,      SC_Z     }
#define O_eDX     { OP_eDX,      SC_Z     }
#define O_rAX     { OP_rAX,      SC_V     }
#define O_rCX     { OP_rCX,      SC_V     }
#define O_rDX     { OP_rDX,      SC_V     }
#define O_sIb     { OP_sI,       SC_B     }
#define O_sIv     { OP_sI,       SC_V     }
#define O_sIz     { OP_sI,       SC_Z     }
