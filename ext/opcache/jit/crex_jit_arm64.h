...
typedef uint64_t crex_regset;

#define CREX_REGSET_64BIT 1

# define CREX_REGSET_FIXED \
	(CREX_REGSET(ZREG_RSP) | CREX_REGSET(ZREG_RLR) | CREX_REGSET(ZREG_RFP) | \
	CREX_REGSET(ZREG_RPR) | CREX_REGSET(ZREG_FP) | CREX_REGSET(ZREG_IP) | \
	CREX_REGSET_INTERVAL(ZREG_TMP1, ZREG_TMP3) | CREX_REGSET(ZREG_FPTMP))
# define CREX_REGSET_GP \
	CREX_REGSET_DIFFERENCE(CREX_REGSET_INTERVAL(ZREG_X0, ZREG_X30), CREX_REGSET_FIXED)
# define CREX_REGSET_FP \
	CREX_REGSET_DIFFERENCE(CREX_REGSET_INTERVAL(ZREG_V0, ZREG_V31), CREX_REGSET_FIXED)
# define CREX_REGSET_SCRATCH \
	(CREX_REGSET_INTERVAL(ZREG_X0, ZREG_X17) | CREX_REGSET_INTERVAL(ZREG_V0, ZREG_V7) | \
	CREX_REGSET_INTERVAL(ZREG_V16, ZREG_V31))
# define CREX_REGSET_PRESERVED \
	(CREX_REGSET_INTERVAL(ZREG_X19, ZREG_X28) | CREX_REGSET_INTERVAL(ZREG_V8, ZREG_V15))

#define CREX_REGSET_LOW_PRIORITY \
	(CREX_REGSET(ZREG_REG0) | CREX_REGSET(ZREG_REG1) | CREX_REGSET(ZREG_FPR0) | CREX_REGSET(ZREG_FPR1))

#endif /* CREX_JIT_ARM64_H */
