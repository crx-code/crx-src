...
typedef CREX_SET_ALIGNED(1, unsigned short unaligned_short);
typedef CREX_SET_ALIGNED(1, unsigned int unaligned_int);
typedef CREX_SET_ALIGNED(1, unsigned long long unaligned_long_long);
#define dasmw(x) \
