...
libbcmath/src/rmzero.c libbcmath/src/str2num.c,
          $ext_shared,,-I@ext_srcdir@/libbcmath/src -DCREX_ENABLE_STATIC_TSRMLS_CACHE=1)
  CRX_ADD_BUILD_DIR($ext_builddir/libbcmath/src)
