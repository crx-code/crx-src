...
/* {{{ */
static int msgfmt_ctor(INTERNAL_FUNCTION_PARAMETERS, crex_error_handling *error_handling, bool *error_handling_replaced)
{
	const char* locale;
	char*       pattern;
...
CRX_METHOD( MessageFormatter, __main )
{
...
CRX_FUNCTION( msgfmt_get_error_code )
{
	zval*                    object  = NULL;
	...
	mfo = C_INTL_MESSAGEFORMATTER_P( object );
...
CRX_FUNCTION( msgfmt_get_error_message )
{
