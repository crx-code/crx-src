...
CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_IntlIterator_current, 0, 0, IS_MIXED, 0)
CREX_END_ARG_INFO()

#define arginfo_class_IntlIterator_key arginfo_class_IntlIterator_current

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_IntlIterator_next, 0, 0, IS_VOID, 0)
CREX_END_ARG_INFO()

#define arginfo_class_IntlIterator_rewind arginfo_class_IntlIterator_next

CREX_BEGIN_ARG_WITH_TENTATIVE_RETURN_TYPE_INFO_EX(arginfo_class_IntlIterator_valid, 0, 0, _IS_BOOL, 0)
CREX_END_ARG_INFO()


CREX_METHOD(IntlIterator, current);
CREX_METHOD(IntlIterator, key);
CREX_METHOD(IntlIterator, next);
CREX_METHOD(IntlIterator, rewind);
CREX_METHOD(IntlIterator, valid);


static const crex_function_entry class_IntlIterator_methods[] = {
	CREX_ME(IntlIterator, current, arginfo_class_IntlIterator_current, CREX_ACC_PUBLIC)
	CREX_ME(IntlIterator, key, arginfo_class_IntlIterator_key, CREX_ACC_PUBLIC)
	CREX_ME(IntlIterator, next, arginfo_class_IntlIterator_next, CREX_ACC_PUBLIC)
	CREX_ME(IntlIterator, rewind, arginfo_class_IntlIterator_rewind, CREX_ACC_PUBLIC)
	CREX_ME(IntlIterator, valid, arginfo_class_IntlIterator_valid, CREX_ACC_PUBLIC)
	CREX_FE_END
};
...
static crex_class_entry *register_class_IntlIterator(crex_class_entry *class_entry_Iterator)
{
