...
static crex_result dtpg_ctor(INTERNAL_FUNCTION_PARAMETERS, crex_error_handling *error_handling, bool *error_handling_replaced)
{
	char *locale_str;
	size_t locale_len = 0;
...
U_CFUNC CRX_METHOD( IntlDatePatternGenerator, create )
{
...
U_CFUNC CRX_METHOD( IntlDatePatternGenerator, __main )
{
...
U_CFUNC CRX_METHOD( IntlDatePatternGenerator, getBestPattern )
{
	...
	crex_string *u8str = intl_charFromString(result, DTPATTERNGEN_ERROR_CODE_P(dtpgo));
