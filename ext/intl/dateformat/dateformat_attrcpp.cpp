...
U_CFUNC CRX_FUNCTION(datefmt_get_timezone_id)
{
	crex_string *u8str;
...
U_CFUNC CRX_FUNCTION(datefmt_get_timezone)
{
	DATE_FORMAT_METHOD_INIT_VARS;
...
U_CFUNC CRX_FUNCTION(datefmt_set_timezone)
{
	zval		*timezone_zv;
	TimeZone	*timezone;
...
U_CFUNC CRX_FUNCTION(datefmt_get_calendar)
{
	DATE_FORMAT_METHOD_INIT_VARS;
...
U_CFUNC CRX_FUNCTION(datefmt_get_calendar_object)
{
	DATE_FORMAT_METHOD_INIT_VARS;
...
U_CFUNC CRX_FUNCTION(datefmt_set_calendar)
{
	crex_object *calendar_obj;
	crex_long calendar_long;
	...
	if (object) {
		...
		CREX_PARSE_PARAMETERS_START(2, 2)
			C_PARAM_OBJECT_OF_CLASS(object, IntlDateFormatter_ce_ptr)
			C_PARAM_OBJ_OF_CLASS_OR_LONG_OR_NULL(calendar_obj, Calendar_ce_ptr, calendar_long, calendar_is_null)
		CREX_PARSE_PARAMETERS_END();
	}
