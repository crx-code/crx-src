...
crex_class_entry *Collator_ce_ptr = NULL;
static crex_object_handlers Collator_handlers;
...
void Collator_objects_free(crex_object *object )
{
	Collator_object* co = crx_intl_collator_fetch_object(object);
...
crex_object *Collator_object_create(crex_class_entry *ce )
{
	Collator_object *intern = crex_object_alloc(sizeof(Collator_object), ce);
