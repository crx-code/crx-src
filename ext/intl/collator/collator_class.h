...
static inline Collator_object *crx_intl_collator_fetch_object(crex_object *obj) {
	return (Collator_object *)((char*)(obj) - XtOffsetOf(Collator_object, zo));
}
#define C_INTL_COLLATOR_P(zv) crx_intl_collator_fetch_object(C_OBJ_P(zv))
...
extern crex_class_entry *Collator_ce_ptr;
