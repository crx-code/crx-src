 ...
 *
 * Modified by Shane Caraveo for use with CRX
 *
 *****************************************************************************/
...
#ifdef CRX_EXPORTS
static crex_always_inline MyGetSystemTimeAsFileTime get_time_func(void)
{/*{{{*/
...
static crex_always_inline int getfilesystemtime(struct timeval *tv)
{/*{{{*/
	FILETIME ft;
...
CRXAPI int gettimeofday(struct timeval *time_Info, struct timezone *timezone_Info)
{/*{{{*/
