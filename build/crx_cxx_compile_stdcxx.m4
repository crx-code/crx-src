...
dnl Author: Anatol Belski <ab@crx.net>
dnl
dnl CRX_CXX_COMPILE_STDCXX(version, mandatory|optional, var_name_to_put_switch_in)
dnl
dnl ARGUMENTS
dnl
...
dnl EXAMPLE
dnl
dnl  CRX_CXX_COMPILE_STDCXX(14, mandatory, MY_STDCXX_SWiTCH)
dnl  echo $MY_STDCXX_SWITCH
dnl

dnl
dnl CRX specific implementation start.
dnl

AC_DEFUN([CRX_CXX_COMPILE_STDCXX], [dnl
  m4_if([$1], [11], [ax_cxx_compile_alternatives="11 0x"],
        [$1], [14], [ax_cxx_compile_alternatives="14 1y"],
        [$1], [17], [ax_cxx_compile_alternatives="17 1z"],
        [$1], [20], [ax_cxx_compile_alternatives="20"],
        [m4_fatal([invalid first argument `$1' to CRX_CXX_COMPILE_STDCXX])])dnl
  m4_if([$2], [], [ax_cxx_compile_cxx$1_required=true],
        ...
        [m4_fatal([invalid third argument `$2' to CRX_CXX_COMPILE_STDCXX])])dnl
  AC_LANG_PUSH([C++])dnl
  ac_success=no
...
dnl
dnl CRX specific implementation end.
