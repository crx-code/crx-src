...
static void register_crex_constants_symbols(int module_number)
{
	...
	REGISTER_BOOL_CONSTANT("CREX_THREAD_SAFE", ZTS_V, CONST_PERSISTENT);
	REGISTER_BOOL_CONSTANT("CREX_DEBUG_BUILD", CREX_DEBUG, CONST_PERSISTENT);
