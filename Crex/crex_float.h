...
*/
extern CREX_API void crex_init_fpu(void);
extern CREX_API void crex_shutdown_fpu(void);
extern CREX_API void crex_ensure_fpu_mode(void);

END_EXTERN_C()

/* Copy of the contents of xpfpa.h (which is under public domain)
   See http://wiki.crx.net/rfc/rounding for details.
